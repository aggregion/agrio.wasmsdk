...
namespace test {
   ...
   struct [[ using agrio: action("testc"), contract("abitest") ]] test_c : testb {
      uint64_t num;
   };
}

CONTRACT abitest : public agrio::contract {
  public:
...
typedef agrio::multi_index< "testtab"_n,  abitest::testtable > testtable_t;
typedef agrio::multi_index< "testtaba"_n, abitest::testtable > testtable_a_t;
typedef agrio::multi_index< "testtab2"_n, abitest::test_table2 > testtable2_t;
