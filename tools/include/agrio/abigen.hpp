...
namespace agrio { namespace cdt {
   struct abigen_exception : public std::exception {
      virtual const char* what() const throw() {
         return "agrio.abigen fatal error";
      }
   };
   ...
   class abigen : public generation_utils {
      ...
      void add_action( const clang::CXXRecordDecl* decl ) {
         abi_action ret;
         auto action_name = decl->getAgrioActionAttr()->getName();
         ...
         if (action_name.empty()) {
            try {
               ...
               std::cout << "Error, name <" <<decl->getName().str() << "> is an invalid AGRIO name.\n";
               throw;
            }
            ...
            try {
               ...
               std::cout << "Error, name <" << action_name.str() << "> is an invalid AGRIO name.\n";
               throw;
            }
      ...
      void add_action( const clang::CXXMethodDecl* decl ) {
         ...
         if (action_name.empty()) {
            try {
               ...
               std::cout << "Error, name <" <<decl->getNameAsString() << "> is an invalid AGRIO name.\n";
            }
      ...
      void add_table( const clang::CXXRecordDecl* decl ) {
         ...
         auto table_name = decl->getAgrioTableAttr()->getName();
         if (!table_name.empty()) {
            try {
      ...
      void add_table( uint64_t name, const clang::CXXRecordDecl* decl ) {
         if (!(decl->isAgrioTable() && abigen::is_agrio_contract(decl, get_contract_name())))
            return;
         abi_table t;
         t.type = decl->getNameAsString();
      ...
      std::string generate_json_comment() {
         std::stringstream ss;
         ss << "This file was generated with agrio-abigen.";
         ss << " DO NOT EDIT ";
         return ss.str(); 
      }
